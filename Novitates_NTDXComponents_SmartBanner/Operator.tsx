...
// interface for props
interface NovitatesNtdxComponentsSmartBannerOperatorProps extends PConnFieldProps {
...
function Operator(props: NovitatesNtdxComponentsSmartBannerOperatorProps) {
